...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-c47764f54d186639539fbb1744d7f6af
VARIABLES items, user, log, pc
...
vars == << items, user, log, pc, current_item >>
...
StartAdd(self) == /\ pc[self] = "StartAdd"
                  ...
                  /\ UNCHANGED << items, user, current_item >>
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-c55ebc673449627c761e0742282ef01c
=============================================================================
